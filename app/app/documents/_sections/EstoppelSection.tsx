...
// Estoppel certificates (resident, read-only) — an Easy Documents tab. An
// estoppel certificate states the amounts owed on a unit/parcel at sale or
// refinance; it's usually requested by a buyer or title/closing agent, and the
// owner sees the request + amounts here via the ev_estoppel_requests owner-read
// RLS. FS 718.116(8) / 720.30851.
...
export function EstoppelSection() {
