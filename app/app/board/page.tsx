...
// Board page — meet-your-board surface. Sunset bare-title hero,
// upcoming-meeting hero card, board updates aside, member row,
// committees list, recent minutes table, How Decisions Are Made
// footer.
//
  ...
  return (
    <div className="brd-wrap">
      <section className="brd-hero">
        <div className="brd-hero-content">
          <h1 className="brd-hero-title">Board</h1>
          <div className="brd-hero-sub">
