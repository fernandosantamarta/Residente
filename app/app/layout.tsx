...
const NAV: NavItem[] = [
  ...
  // Account Standing (/app/collections) and Estoppel (/app/estoppel) used to live
  // here; Estoppel now lives under Settings (next to Home Vault + Transfer) and
  // Account Standing was removed from the sidebar. Both pages remain reachable by
  // URL / their relocated entry points.
]
