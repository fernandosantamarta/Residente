...
// wired, swap VENDORS for the real query.
...
export default function Vendors() {
  ...
  return (
    <div className="ven-wrap">
      <section className="ven-hero">
        <div className="ven-hero-content">
          <h1 className="ven-hero-title">Vendors</h1>
          <div className="ven-hero-sub">
