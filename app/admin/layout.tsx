...
const ADMIN_NAV: AdminNavItem[] = [
  ...
  { href: '/admin/charges',    label: 'admin.nav.charges', anyPerm: ['financials.view', 'payments.view'] },
  { href: '/admin/residents',  label: 'admin.nav.easyTrack', anyPerm: ['residents.view', 'residents.manage'], match: ['/admin/vendor'] },
  { href: '/admin/work-orders', label: 'admin.nav.workOrders', anyPerm: ['community.manage', 'violations.manage'] },
