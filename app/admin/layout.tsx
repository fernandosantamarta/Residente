...
// Consolidation (docs/ADMIN-CONSOLIDATION-PLAN.md): the Compliance tab stays
// (Fernando's call — next to Budget), and every workspace is ALSO reachable
// from WorkspaceLinks cards on the everyday tab that hosts it.
